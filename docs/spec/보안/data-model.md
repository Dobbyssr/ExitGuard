...
| `Standard`(rail=security) | ISMS-P 인증기준 2.2.5 퇴직 및 직무변경 관리(근거 배지용) | §4 |
...
|---|---|---|---|---|---|
| **L3** | ISMS-P 인증기준 2.2.5 (퇴직 및 직무변경 관리) | 퇴직·직무변경 시 자산반납·계정 및 접근권한 회수·조정·결과확인 | "퇴직 및 직무변경 시 인사·정보보호·개인정보보호·IT 등 관련 부서별 이행하여야 할 자산반납, 계정 및 접근권한 회수·조정, 결과확인 등의 절차를 수립·관리하여야 한다." — SEC-01 회수 체크리스트(계정·SaaS·기기 회수 상신→확인)와 정확히 일치. | https://www.privacy.go.kr/front/bbs/bbsView.do?bbsNo=BBSMSTR_000000000049&bbscttNo=20677 | v2023.11 |

> **근거 정정(2026-07-20)**: 종전 L1 "정보통신망법 제28조"는 개인정보의 기술적·관리적 보호조치(접근통제·암호화·백신)를 규정하는 조항으로, **퇴사자 계정·접근권한 회수를 규정하는 조항이 아니어서 내용 불일치**였다(도비 원문 확인). SEC-01 체크리스트 내용과 정확히 일치하는 **ISMS-P 인증기준 2.2.5(퇴직 및 직무변경 관리)**로 교체하고, ISMS-P는 개인정보보호위원회·KISA가 운영하는 법정 인증제도의 인증기준이므로 tier를 **L3(정부/공인 가이드·인증기준)**로 조정했다. 출처는 개인정보보호위원회·과학기술정보통신부 공동 발행 「ISMS-P 인증기준 안내서(2023.11. 개정)」 공식 게시본(privacy.go.kr) — 위키·민간 사본 아님.
> SEC CP(01·02)는 `[시뮬데이터]`라 판례(L2) 대조 없음. 근거 배지는 L3 최소 1건.
