...
| **L2** | 대법원 2008. 7. 10. 선고 **2008도3435** 판결 (부정경쟁방지및영업비밀보호에관한법률위반) — 비밀관리성 판단 기준 | 비밀관리성 인정 요소 | "'상당한 노력에 의하여 비밀로 유지된다'는 것은 그 정보가 비밀이라고 인식될 수 있는 **표시를 하거나 고지**를 하고, 그 정보에 **접근할 수 있는 대상자나 접근 방법을 제한**하거나 그 정보에 접근한 자에게 **비밀준수의무를 부과**하는 등 객관적으로 그 정보가 비밀로 유지·관리되고 있다는 사실이 인식 가능한 상태를 의미한다." — 해당 사건에서 법원은 파일에 보관책임자 미지정·보안장치·규정 부재·중요도 분류나 "대외비"표시 없음·**연구원뿐 아니라 생산직 사원도 자유롭게 접근 가능**했던 점을 비밀관리성 불인정 근거로 들었다(우리 compare 규칙 §4-2의 "비밀표시 없음 + 전원 접근" 패턴과 정확히 대응). **비고**: 본 판결은 2019년 법 개정 전 "상당한 노력" 구법 기준을 적용한 것이다. 2019년 개정으로 조문이 "비밀로 관리된"으로 완화됐으나, 표시·접근제한·비밀준수의무라는 판단 요소 자체는 후속 실무·판례에서도 계속 참조되는 대표 판시이므로 L2 근거로 유효하다(법 개정으로 기준이 바뀐 것으로 오인 금지). | https://casenote.kr/대법원/2008도3435 | v2026.06 |
...
> **L2 사건번호 확정(2026-07-20)**: 비밀관리성 판단 기준 판례 = **대법원 2008. 7. 10. 선고 2008도3435 판결**(도비 웹 리서치 검증 — 창작 아님). 사실관계(비밀표시 없음 + 연구원·생산직 전원 접근)가 우리 §4-2 패턴과 정확히 대응. 2019년 법 개정 전 "상당한 노력" 구법 기준 판결이나 판단 요소는 후속 실무에서 계속 참조되는 대표 판시(비고 명시). risk 행 프레이밍은 종전대로 "…판단된 사례가 있습니다" 유지.
